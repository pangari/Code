...
static unsigned long ice_perm32 (
...
static void ice_key_sched_build (
                                 ICE_KEY        *ik,
                                 unsigned short    *kb,
                                 int        n,
                                 const int    *keyrot
