...
static void pline(register char buf[])
{
...
*/
static int equal(register char b1[], register char b2[])
{
    b1 = skip(b1);
    b2 = skip(b2);
...
static void parseargs(int ac, char **av)
{
    ...
    if ((mav = (char**)malloc(mav_sz)) == (char **) NULL) {
    ...
    while ((av[i] != (char *) NULL) && (av[i][0] != (char) NULL)) {
        ...
        */
        if ((fflag == 0) && (minusflag == 0) && (av[i][0] == '+')) {
            ...
            mav_sz += sizeof (char *);
            if ((mav = (char**)realloc(mav, mav_sz)) == (char **) NULL) {
                perror("realloc failed");
                exit(1);
            }

            if ((mav[mac] = (char*)malloc(sizeof ("-m") + 1)) ==
                (char *) NULL) {
                    perror("malloc failed");
                    exit(1);
            }
            ...
            if ((mav[mac] = (char*)malloc(strlen(&av[i][1]) + 1)) ==
                (char *) NULL) {
                    perror("malloc failed");
                    exit(1);
            }
        ...
        */
        if ((fflag == 0) && (minusflag == 0) && (av[i][0] == '-') &&
            (av[i][1] != (char) NULL) && (atoi(&av[i][1]) > 0)) {
                ...
                if ((mav[mac] = (char*)malloc(sizeof ("-n") + 1)) ==
                    (char *) NULL) {
                        perror("malloc failed");
                        exit(1);
                }
        ...
        sz = strlen(&av[i][0]);
        if ((mav[mac] = (char*)malloc(sz + 1)) == (char *) NULL) {
            perror("malloc failed");
            exit(1);
        }
